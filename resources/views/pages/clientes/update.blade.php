...
<form class="form" method="POST" action="{{route('atualizar.cliente', $findCLiente->id)}}"> 
    ...
    <div class="mb-3">
      ...
      <input id="mascara_endereco" type="text" class="form-control @error('endereco') is-invalid @enderror" name="endereco" value="{{isset($findCLiente->endereco) ? $findCLiente->endereco : old('endereco')}}">
